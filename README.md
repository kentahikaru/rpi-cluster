...
# After fresh Raspberryos install
1. put "ssh" file into boot dir [ssh setup headless](https://www.raspberrypi.org/documentation/remote-access/ssh/)
2. put "wpa_supplicant.conf" into boot dir (country included) [wifi setup headless](https://www.raspberrypi.org/documentation/configuration/wireless/headless.md)
3. put "iwconfig wlan0 power off" to /etc/rc.local
4. add ssh key to ~/.ssh/authorized_keys
